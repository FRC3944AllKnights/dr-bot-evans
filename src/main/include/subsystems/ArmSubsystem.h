...
class ArmSubsystem : public frc2::SubsystemBase {
 ...
 private:
    ...
    MotionControlArmSubsystem m_elbow{2, 0, 6.406856, 4, 0.2, 0, ArmConstants::elbowGearRatio, 6.54498};
    MotionControlArmSubsystem m_shoulder{1, 1, 4.914566, 6, 7.5, 0, ArmConstants::shoulderGearRatio, 4.88692};
};
